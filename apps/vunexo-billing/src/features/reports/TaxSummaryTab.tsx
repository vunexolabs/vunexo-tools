        ...
        <>
          <div className="flex items-center justify-between">
            <p className="text-sm text-slate-400">
              Total tax ({code}): <span className="font-semibold text-slate-200">{symbol}{formatMinor(result.total_tax_minor)}</span>
            </p>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                {result.by_regime.map((row) => (
                  <tr key={row.tax_regime} className="border-t border-slate-800">
                    <td className="py-2">{row.tax_regime}</td>
                    <td className="py-2 text-slate-400">{symbol}{formatMinor(row.tax_amount_minor)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
