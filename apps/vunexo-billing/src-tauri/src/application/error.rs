...
impl std::fmt::Display for ApplicationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ApplicationError::Conflict(msg) => write!(f, "{msg}"),
...
/// Serializable shape for the Tauri command boundary (application-architecture.md §6) —
/// `InfrastructureError`'s own message never crosses this boundary verbatim.
